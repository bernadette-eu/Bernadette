...
Before performing MCMC, the user can opt to execute the routine for maximizing the joint posterior from the model. The estimates can be used as initialization points for the HMC algorithm by setting the option `r, eval=F init = igbm_fit_init` in `r, eval=F stan_igbm`.
