...
#include "stanExports_dummy_lm_model.h"

RCPP_MODULE(stan_fit4dummy_lm_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_dummy_lm_model")
