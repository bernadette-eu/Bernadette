...
#include "stanExports_seeiir_mbm_ncp_gamma_volatilities.h"

RCPP_MODULE(stan_fit4seeiir_mbm_ncp_gamma_volatilities_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_seeiir_mbm_ncp_gamma_volatilities")
