...
namespace model_seeiir_sbm_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_seeiir_sbm");
    reader.add_event(391, 389, "end", "model_seeiir_sbm");
    return reader;
}
...
ODE_states(const T0__& time,
    ...
    try {
        ...
        stan::math::assign(beta,get_base1(theta, ((A * A) + 4), "theta", 1));
...
integrate_ode_trapezoidal(const std::vector<T0__>& y_initial,
    ...
    try {
        ...
        validate_non_negative_index("theta_ODE", "((A * A) + 4)", ((A * A) + 4));
        std::vector<local_scalar_t__  > theta_ODE(((A * A) + 4), local_scalar_t__(DUMMY_VAR__));
        ...
        for (int t = 0; t <= (size(times) - 1); ++t) {
            ...
            if (as_bool(logical_eq(t, 0))) {
                ...
                stan::model::assign(theta_ODE, 
                            stan::model::cons_list(stan::model::index_uni(((A * A) + 4)), stan::model::nil_index_list()), 
                ...
                if (as_bool(logical_eq(t, (size(times) - 1)))) {
                    ...
                    stan::model::assign(theta_ODE, 
                                stan::model::cons_list(stan::model::index_uni(((A * A) + 4)), stan::model::nil_index_list()), 
                                get_base1(theta, (((A * A) + n_obs) + 2), "theta", 1), 
                                "assigning variable theta_ODE");
                    ...
                    stan::model::assign(theta_ODE, 
                                stan::model::cons_list(stan::model::index_uni(((A * A) + 4)), stan::model::nil_index_list()), 
                                get_base1(theta, (((A * A) + t) + 2), "theta", 1), 
                                "assigning variable theta_ODE");
                }
...
class model_seeiir_sbm
  : public stan::model::model_base_crtp<model_seeiir_sbm> {
private:
        int A;
        int n_obs;
        int n_weeks;
        ...
        vector_d L_vector;
public:
    model_seeiir_sbm(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_seeiir_sbm_namespace::model_seeiir_sbm";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "p_phiD", "double", context__.to_vec());
            p_phiD = double(0);
            vals_r__ = context__.vals_r("p_phiD");
            pos__ = 0;
            p_phiD = vals_r__[pos__++];
            ...
            validate_non_negative_index("p_sigmaBM", "2", 2);
            context__.validate_dims("data initialization", "p_sigmaBM", "double", context__.to_vec(2));
            p_sigmaBM = std::vector<double>(2, double(0));
            vals_r__ = context__.vals_r("p_sigmaBM");
            pos__ = 0;
            size_t p_sigmaBM_k_0_max__ = 2;
            ...
            validate_non_negative_index("eta_noise", "(n_weeks - 1)", (n_weeks - 1));
            num_params_r__ += (1 * (n_weeks - 1));
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "eta_init", "double", context__.to_vec());
        double eta_init(0);
        eta_init = vals_r__[pos__++];
        try {
            writer__.scalar_unconstrain(eta_init);
        } catch (const std::exception& e) {
        ...
        pos__ = 0U;
        validate_non_negative_index("eta_noise", "(n_weeks - 1)", (n_weeks - 1));
        context__.validate_dims("parameter initialization", "eta_noise", "double", context__.to_vec((n_weeks - 1)));
        std::vector<double> eta_noise((n_weeks - 1), double(0));
        size_t eta_noise_k_0_max__ = (n_weeks - 1);
        for (size_t k_0__ = 0; k_0__ < eta_noise_k_0_max__; ++k_0__) {
            eta_noise[k_0__] = vals_r__[pos__++];
        }
        size_t eta_noise_i_0_max__ = (n_weeks - 1);
        ...
        pos__ = 0U;
        context__.validate_dims("parameter initialization", "sigmaBM", "double", context__.to_vec());
        double sigmaBM(0);
        sigmaBM = vals_r__[pos__++];
        try {
            writer__.scalar_lb_unconstrain(get_base1(p_sigmaBM, 1, "p_sigmaBM", 1), sigmaBM);
        } catch (const std::exception& e) {
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            current_statement_begin__ = 248;
            local_scalar_t__ eta_init;
            (void) eta_init;  // dummy to suppress unused var warning
            if (jacobian__)
                eta_init = in__.scalar_constrain(lp__);
            else
                eta_init = in__.scalar_constrain();
            current_statement_begin__ = 249;
            std::vector<local_scalar_t__> eta_noise;
            size_t eta_noise_d_0_max__ = (n_weeks - 1);
            ...
            current_statement_begin__ = 252;
            local_scalar_t__ sigmaBM;
            (void) sigmaBM;  // dummy to suppress unused var warning
            if (jacobian__)
                sigmaBM = in__.scalar_lb_constrain(get_base1(p_sigmaBM, 1, "p_sigmaBM", 1), lp__);
            else
                sigmaBM = in__.scalar_lb_constrain(get_base1(p_sigmaBM, 1, "p_sigmaBM", 1));
            current_statement_begin__ = 253;
            ...
            std::vector<local_scalar_t__> eta_weekly(n_weeks, local_scalar_t__(0));
            ...
            std::vector<local_scalar_t__> beta_weekly(n_weeks, local_scalar_t__(0));
            ...
            std::vector<local_scalar_t__> beta_N(n_obs, local_scalar_t__(0));
            stan::math::initialize(beta_N, DUMMY_VAR__);
            stan::math::fill(beta_N, DUMMY_VAR__);
            current_statement_begin__ = 266;
            validate_non_negative_index("theta", "((n_obs + (A * A)) + 4)", ((n_obs + (A * A)) + 4));
            std::vector<local_scalar_t__> theta(((n_obs + (A * A)) + 4), local_scalar_t__(0));
            ...
            for (int i = 2; i <= n_weeks; ++i) {
                ...
                stan::model::assign(eta_weekly, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            (get_base1(eta_weekly, (i - 1), "eta_weekly", 1) + (sigmaBM * get_base1(eta_noise, (i - 1), "eta_noise", 1))), 
                            "assigning variable eta_weekly");
            }
            ...
            stan::math::assign(beta_N, rep_each(beta_weekly, 7, pstream__));
            ...
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_min_max(((A * A) + 3), (((A * A) + n_obs) + 2)), stan::model::nil_index_list()), 
                        beta_N, 
                        "assigning variable theta");
            current_statement_begin__ = 299;
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(((n_obs + (A * A)) + 3)), stan::model::nil_index_list()), 
                        pi, 
                        "assigning variable theta");
            current_statement_begin__ = 300;
            stan::model::assign(theta, 
                        stan::model::cons_list(stan::model::index_uni(((n_obs + (A * A)) + 4)), stan::model::nil_index_list()), 
                        tau, 
                        "assigning variable theta");
            ...
            (void) function__;  // dummy to suppress unused var warning
            current_statement_begin__ = 260;
            size_t eta_weekly_k_0_max__ = n_weeks;
            for (size_t k_0__ = 0; k_0__ < eta_weekly_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(eta_weekly[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: eta_weekly" << "[" << k_0__ << "]";
            ...
            current_statement_begin__ = 263;
            size_t beta_weekly_k_0_max__ = n_weeks;
            for (size_t k_0__ = 0; k_0__ < beta_weekly_k_0_max__; ++k_0__) {
                if (stan::math::is_uninitialized(beta_weekly[k_0__])) {
                    std::stringstream msg__;
                    msg__ << "Undefined transformed parameter: beta_weekly" << "[" << k_0__ << "]";
            ...
            size_t beta_weekly_i_0_max__ = n_weeks;
            for (size_t i_0__ = 0; i_0__ < beta_weekly_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "beta_weekly[i_0__]", beta_weekly[i_0__], 0);
            }
            current_statement_begin__ = 264;
            size_t beta_N_k_0_max__ = n_obs;
            ...
            lp_accum__.add(normal_log<propto__>(eta_init, 0, get_base1(p_sigmaBM, 2, "p_sigmaBM", 1)));
            current_statement_begin__ = 347;
            lp_accum__.add(beta_log<propto__>(pi, get_base1(p_pi, 1, 1, "p_pi", 1), get_base1(p_pi, 1, 2, "p_pi", 1)));
            current_statement_begin__ = 348;
            lp_accum__.add(normal_log<propto__>(sigmaBM, 0, get_base1(p_sigmaBM, 2, "p_sigmaBM", 1)));
            current_statement_begin__ = 349;
            lp_accum__.add(exponential_log<propto__>(phiD, p_phiD));
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_seeiir_sbm_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        // read-transform, write parameters
        double eta0 = in__.scalar_constrain();
        vars__.push_back(eta0);
        double eta_init = in__.scalar_constrain();
        vars__.push_back(eta_init);
        ...
        vars__.push_back(pi);
        double sigmaBM = in__.scalar_lb_constrain(get_base1(p_sigmaBM, 1, "p_sigmaBM", 1));
        vars__.push_back(sigmaBM);
        ...
        try {
            ...
            current_statement_begin__ = 260;
            validate_non_negative_index("eta_weekly", "n_weeks", n_weeks);
            std::vector<double> eta_weekly(n_weeks, double(0));
            stan::math::initialize(eta_weekly, DUMMY_VAR__);
            stan::math::fill(eta_weekly, DUMMY_VAR__);
            current_statement_begin__ = 261;
            double beta0;
            ...
            current_statement_begin__ = 263;
            validate_non_negative_index("beta_weekly", "n_weeks", n_weeks);
            std::vector<double> beta_weekly(n_weeks, double(0));
            stan::math::initialize(beta_weekly, DUMMY_VAR__);
            stan::math::fill(beta_weekly, DUMMY_VAR__);
            current_statement_begin__ = 264;
            validate_non_negative_index("beta_N", "n_obs", n_obs);
            std::vector<double> beta_N(n_obs, double(0));
            stan::math::initialize(beta_N, DUMMY_VAR__);
            stan::math::fill(beta_N, DUMMY_VAR__);
            current_statement_begin__ = 266;
            validate_non_negative_index("theta", "((n_obs + (A * A)) + 4)", ((n_obs + (A * A)) + 4));
            std::vector<double> theta(((n_obs + (A * A)) + 4), double(0));
            stan::math::initialize(theta, DUMMY_VAR__);
            stan::math::fill(theta, DUMMY_VAR__);
            current_statement_begin__ = 267;
            validate_non_negative_index("state_solutions", "n_obs", n_obs);
            ...
            if (include_tparams__) {
                size_t eta_weekly_k_0_max__ = n_weeks;
                for (size_t k_0__ = 0; k_0__ < eta_weekly_k_0_max__; ++k_0__) {
                    vars__.push_back(eta_weekly[k_0__]);
                }
                vars__.push_back(beta0);
                size_t beta_weekly_k_0_max__ = n_weeks;
                for (size_t k_0__ = 0; k_0__ < beta_weekly_k_0_max__; ++k_0__) {
                    vars__.push_back(beta_weekly[k_0__]);
                }
                size_t beta_N_k_0_max__ = n_obs;
                for (size_t k_0__ = 0; k_0__ < beta_N_k_0_max__; ++k_0__) {
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t k_0__ = 0; k_0__ < eta_weekly_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "eta_weekly" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            param_name_stream__.str(std::string());
            ...
            for (size_t k_0__ = 0; k_0__ < beta_weekly_k_0_max__; ++k_0__) {
                param_name_stream__.str(std::string());
                param_name_stream__ << "beta_weekly" << '.' << k_0__ + 1;
                param_names__.push_back(param_name_stream__.str());
            }
            size_t beta_N_k_0_max__ = n_obs;
            for (size_t k_0__ = 0; k_0__ < beta_N_k_0_max__; ++k_0__) {
...
typedef model_seeiir_sbm_namespace::model_seeiir_sbm stan_model;
#ifndef USING_R
